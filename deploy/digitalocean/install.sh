#!/bin/bash
#
# MobileDroid Installation Script for DigitalOcean
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/serup-ai/mobiledroid/main/deploy/digitalocean/install.sh | bash
#
# Or download and run with API key:
#   curl -O https://raw.githubusercontent.com/serup-ai/mobiledroid/main/deploy/digitalocean/install.sh
#   chmod +x install.sh
#   ANTHROPIC_API_KEY=sk-ant-xxx ./install.sh
#
# Requirements:
#   - Ubuntu 22.04 Droplet
#   - Minimum: 2 vCPU, 4GB RAM (s-2vcpu-4gb)
#   - Recommended: 4 vCPU, 8GB RAM (s-4vcpu-8gb)
#
