...
# from src.routers.chat import router as chat_router  # TODO: Fix agent import path

__all__ = ["profiles_router", "devices_router", "tasks_router", "fingerprints_router", "stream_router", "snapshots_router"]  # "chat_router"]
